...
| `* * *`  | lawyer                                                            | access my contacts without internet                               | so that I can continue to work effectively in places with limited to no connectivity     |
...
| `* *`    | forgetful lawyer                                                  | view a quick summary for certain commands                         | quickly relearn how to perform certain commands in case I forgot how to use them         |
