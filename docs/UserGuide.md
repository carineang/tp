...
4. (**Some Linux computers only**) On fresh startup of the application, the size of the window cannot be modified. Only after maximising and the minimising the application, the size of the window can be modified.
